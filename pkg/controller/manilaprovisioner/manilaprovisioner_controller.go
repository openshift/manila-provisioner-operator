...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileManilaProvisioner{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ManilaProvisioner
...
func (r *ReconcileManilaProvisioner) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set ManilaProvisioner instance as the owner and controller
...
func newPodForCR(cr *manilav1alpha1.ManilaProvisioner) *corev1.Pod {
